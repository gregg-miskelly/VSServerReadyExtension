...
namespace VSServerReadyLauncher
{
    ...
    {
        /// <summary>
        /// VSServerReadyLauncherPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "0ba26a42-6733-4fcb-9a78-4262d52fdd60";
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            DebuggerEventCallback.EnsureRegistered(this);
...
#pragma warning restore VSTHRD108 // Assert thread affinity unconditionally
                DebuggerEventCallback.EnsureUnregistered();
            }
        ...
        public T GetRequiredService<T>(Type serviceType)
        {
            ...
            object result = this.GetService(serviceType);
            if (result == null)
            {
